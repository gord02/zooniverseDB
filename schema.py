...
async def createEvent():
    event_model: dict = {
        ...
        "snr": 7.9,
        "beams": [123, 1123],
        # Changed representation of the keys 123 and 1123 to a strings because within the BSON spec, intergers are not valid; Keys must be Strings as required in the specification.
        "data_paths": {
            '123': "path to b1",
            '1123': "path to b2",
        },
